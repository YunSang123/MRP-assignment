...
x1_true = x1_p + w; % True x1 position
...
z3 = 5;
R3 = 1;
r_minus = sqrt(x1_p(1)^2+x1_p(2)^2);

H3 = [x1_p(1)/r_minus x1_p(2)/r_minus 0];
disp(H3*x1_p)
...
H = [1 0 0;
     0 1 0;
     x1_p(1)/r_minus x1_p(2)/r_minus 0];

% predicted measurement from predicted values
z_minus = [x1_p(1) x1_p(2) r_minus]';
